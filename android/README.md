...
```gradle
dependencies {
    implementation 'com.github.apiverve:vowelcounter-api:1.1.14'
}
```
...
```java
import com.apiverve.vowelcounter.VowelCounterAPIClient;
import com.apiverve.vowelcounter.APIResponse;
import com.apiverve.vowelcounter.APIException;

// Initialize the client
VowelCounterAPIClient client = new VowelCounterAPIClient("YOUR_API_KEY");

try {
    // Prepare request parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("text", "The quick brown fox jumps over the lazy dog. This pangram contains every letter of the alphabet at least once.");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/vowelcounter](https://docs.apiverve.com/ref/vowelcounter)
...
- **Documentation:** [https://docs.apiverve.com/ref/vowelcounter](https://docs.apiverve.com/ref/vowelcounter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/vowelcounter-api/issues)
