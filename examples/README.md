# Vowel Counter API - Examples

This folder contains example code for using the Vowel Counter API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/vowelcounter',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/vowelcounter");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/vowelcounter](https://docs.apiverve.com/ref/vowelcounter)
