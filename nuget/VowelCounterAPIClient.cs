...
namespace APIVerve.API.VowelCounter
{
    ...
    /// <summary>
    /// Client for the VowelCounter API
    /// </summary>
    public class VowelCounterAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/vowelcounter";
        ...
        public VowelCounterAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public VowelCounterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public VowelCounterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, VowelCounterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(VowelCounterQueryOptions options)
        {
        ...
        public ResponseObj Execute(VowelCounterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(VowelCounterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(VowelCounterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(VowelCounterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(VowelCounterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(VowelCounterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(VowelCounterQueryOptions options)
        {
