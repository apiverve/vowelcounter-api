...
const (
	baseURL        = "https://api.apiverve.com/v1/vowelcounter"
	defaultTimeout = 30 * time.Second
)

// Client is the Vowel Counter API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Vowel Counter API client.
...
// Execute makes a request to the Vowel Counter API with typed parameters.
//
