// Package vowelcounter provides a Go client for the Vowel Counter API.
//
// For more information, visit: https://apiverve.com/marketplace/vowelcounter?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Vowel Counter API.
//
// Parameters:
//   - text (required): string - Text to analyze (max 50,000 characters)
type Request struct {
...
// ResponseData contains the data returned by the Vowel Counter API.
type ResponseData struct {
	Vowels int `json:"vowels"`
	Consonants int `json:"consonants"`
	TotalLetters int `json:"totalLetters"`
	VowelPercentage float64 `json:"vowelPercentage"`
	ConsonantPercentage float64 `json:"consonantPercentage"`
	VowelBreakdown VowelBreakdownData `json:"vowelBreakdown"`
	TextLength int `json:"textLength"`
}

// VowelBreakdownData represents the vowelBreakdown object.
type VowelBreakdownData struct {
	A int `json:"a"`
	E int `json:"e"`
	I int `json:"i"`
	O int `json:"o"`
